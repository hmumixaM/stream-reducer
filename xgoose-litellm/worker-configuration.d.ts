/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e88fe96b19cad1a2d0fc6be5d1ea0a22)
// Runtime types generated with workerd@1.20260908.1 2025-09-23 
interface __BaseEnv_Env {
	DB: D1Database;
	CF_VERSION_METADATA: WorkerVersionMetadata;
	GEMINI_PROXY_BASE: "https://xgoose-gemini-proxy.max-678.workers.dev/v1";
	LITELLM: DurableObjectNamespace<import("./src/index").LiteLLMContainer>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "LiteLLMContainer";
	}
